"use strict";
cc._RF.push(module, '6743e+fDyZDbJB56P0i5jUv', 'CSFFFWheel');
// Texture/Slot_CaishenFafafa/js/CSFFFWheel.js
...
cc.Class({
  ...
  onLoad: function onLoad() {
    this.audio = cc.director.getScene().getChildByName('Canvas').getComponent('CSFFFAudio');
    this.mainObj = cc.director.getScene().getChildByName('Canvas').getComponent('CSFFFMain');
