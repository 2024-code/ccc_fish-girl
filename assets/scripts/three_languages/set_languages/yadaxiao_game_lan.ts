...
export default class yadaxiao_game_lan extends cc.Component {
    ...
    protected start(): void {
        ...
        if (!window.globalData_8) {
            window.globalData_8 = {} as GlobalData_8;
        }
    ...
    private setLanguage(): void {
        ...
        const yourScriptComponent = persistNode.getComponent('yadaxiao_game_lan');

        const globalLabelArr = window.globalData_8.labelArr || [];
        this.labelArr = globalLabelArr.length ? globalLabelArr : this.labelArr;

        const globalSpriteArr = window.globalData_8.spriteArr || [];
        this.spriteArr = globalSpriteArr.length ? globalSpriteArr : this.spriteArr;

        const globalSpriteFrameArr_zh = window.globalData_8.spriteFrameArr_zh || [];
        this.spriteFrameArr_zh = globalSpriteFrameArr_zh.length ? globalSpriteFrameArr_zh : this.spriteFrameArr_zh;

        const globalSpriteFrameArr_en = window.globalData_8.spriteFrameArr_en || [];
        this.spriteFrameArr_en = globalSpriteFrameArr_en.length ? globalSpriteFrameArr_en : this.spriteFrameArr_en;

        const globalSpriteFrameArr_vn = window.globalData_8.spriteFrameArr_vn || [];
