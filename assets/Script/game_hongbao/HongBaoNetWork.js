...
var HongBaoNetWork = (function () {
    ...
    function Single() {
        ...
        this.bindSocketCallback = function () {
            ...
            * 获取红包列表
            */
            this.gameSocket.on("hongbaoList", (ret) => {
                var result = self.changeResultJSON_Function(ret);
            ...
            * 领红包结果返回
            */
            this.gameSocket.on("getHbResult", (ret) => {
                var result = self.changeResultJSON_Function(ret);
            ...
            this.gameSocket.on("CanExit", ret => {
                ret = self.changeResultJSON_Function(ret);
                console.log('canExit', ret.result);
                self.gameMain.com_Button.getChildByName("bt_Exit").active = ret.result;
