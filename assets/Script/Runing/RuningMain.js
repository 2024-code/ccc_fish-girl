...
cc.Class({
    ...
    checkLandlords(e, t, i) {
        ...
        for (var n = 0; n < this.pb_LandloadsCard.length; n++) 13.1 == t[n].val ? t[n].val = 1 : 13.2 == t[n].val && (t[n].val = 2),
            this.pb_LandloadsCard[n].getComponent("RunCards").cardsCreate(t[n].val, t[n].type);
        if (e == this.netWork.playerId) {
            ...
            for (var n = 0; n < t.length; n++) {
                ...
                o = this.cardsPool.size() > 0 ? this.cardsPool.get() : cc.instantiate(this.pb_Cards),
                    ...
                    o.getComponent("RunCards").cardsCreate(t[n].val, t[n].type),
            ...
            for (var n = 0,
                ...
                if (this.playerCards[n].getComponent("RunCards").val > 13) a = n;
                else if (2 == this.playerCards[n].getComponent("RunCards").val || 1 == this.playerCards[n].getComponent("RunCards").val) {
                s = n;
                break
            }
            if (null == a && null != s) {
        ...
        switch (1 == o && null != this.btnPlayerState && (this.btnPlayerState.active = false), t) {
            ...
            case "不出":
                if (this.allTips[o].getChildByName("No").active = true, this.pInfo.soundEffectControl && cc.audioEngine.play(this.buYaoAudio[Math.floor(3 * Math.random())], false, 1), 1 == o) {
                    for (var a = 0; a < this.playerCards.length; a++) this.playerCards[a].position.y == this.movedY && this.playerCards[a].getComponent("RunCards").moveCard();
                    this.selectedCard = [],
                        this.count = 0
                }
    ...
    otherPlayerOutCard(e, t, i) {
        ...
        if (e.length > 0) {
            ...
            for (var o = 0; o < e.length; o++) a = this.cardsPool.size() > 0 ? this.cardsPool.get() : cc.instantiate(this.pb_Cards),
                ...
                a.getComponent("RunCards").cardsCreate(e[o].val, e[o].type),
                s.push(a);
    ...
    settlement(e, closeDoor, bp) {
            ...
            for (var i = 0; i < this.tempPlayersLists.length; i++)
                if (e[t].userId == this.tempPlayersLists[i].id) {
                    0 == i ? (this.otherOneL.getChildByName("bg_name").getChildByName("Score").getComponent("cc.Label").string = ((e[t].Fraction + e[t].score) / this.pInfo.exchangeRate).toFixed(2), this.landloadsLogo[i].active && !this.landloadsLogo[1].active ? this.billMessage[i].getChildByName("bet").getComponent("cc.Label").string = "x" + e[t].card_num : this.landloadsLogo[i].active || this.landloadsLogo[1].active ? this.landloadsLogo[1].active && (this.billMessage[i].getChildByName("bet").getComponent("cc.Label").string = "x" + e[t].card_num) : this.billMessage[i].getChildByName("bet").getComponent("cc.Label").string = "x" + e[t].card_num) : 1 == i ? (this.node.getChildByName("Bill").active = true, e[t].Fraction > 0 ? this.node.getChildByName("Bill").getChildByName("jieShuan").getComponent("dragonBones.ArmatureDisplay").armature().animation.play("shengli", 0) : this.node.getChildByName("Bill").getChildByName("jieShuan").getComponent("dragonBones.ArmatureDisplay").armature().animation.play("shibai", 0), this.pInfo.soundEffectControl && (e[t].Fraction > 0 ? cc.audioEngine.play(this.shuYing[1], false, 1) : cc.audioEngine.play(this.shuYing[0], false, 1)), this.pb_Lower.getChildByName("gold").getChildByName("integral").getComponent("cc.Label").string = (e[t].Fraction / this.pInfo.exchangeRate).toFixed(2), this.node.getChildByName("Bill").getComponent("cc.Sprite").spriteFrame = this.billBg[1], this.node.getChildByName("blackFace").active = true, this.node.getChildByName("blackFace").getChildByName("btn_Signout").active = true, this.billMessage[i].getChildByName("bet").getComponent("cc.Label").string = "x" + e[t].card_num) : 2 == i && (this.otherTwoR.getChildByName("bg_name").getChildByName("Score").getComponent("cc.Label").string = ((e[t].Fraction + e[t].score) / this.pInfo.exchangeRate).toFixed(2), this.landloadsLogo[i].active && !this.landloadsLogo[1].active ? this.billMessage[i].getChildByName("bet").getComponent("cc.Label").string = "x" + e[t].card_num : this.landloadsLogo[i].active || this.landloadsLogo[1].active ? this.landloadsLogo[1].active && (this.billMessage[i].getChildByName("bet").getComponent("cc.Label").string = "x" + e[t].card_num) : this.billMessage[i].getChildByName("bet").getComponent("cc.Label").string = "x" + e[t].card_num),
                        ...
                        this.billMessage[i].getChildByName("bottomScore").getComponent("cc.Label").string = (e[t].Bottom / this.pInfo.exchangeRate).toFixed(2); //this.pb_Lower.getChildByName("di").getChildByName("bottomScore").getComponent("cc.Label").string,
        ...
        this.node.getChildByName("btn_Continue-game").active = true,
        ...
        switch (e.type) {
            case 0:
                ...
                for (var s = 0; s < this.pureArr.length; s++)
                    for (var c = 0; c < this.pureArr[s].length; c++) o = 1 == this.pureArr[s][c][0].getComponent("RunCards").val ? 13.1 : 2 == this.pureArr[s][c][0].getComponent("RunCards").val ? 13.2 : this.pureArr[s][c][0].getComponent("RunCards").val,
        ...
        if (res.code) {
            for (let i in res.card) {
                for (let j in this.playerCards) {
                    if (this.playerCards[j].getComponent("RunCards").val == res.card[i].val && this.playerCards[j].getComponent("RunCards").type == res.card[i].type) {
    ...
    teShuChuPai(e) {
        for (var t, i = [], n = 0; n < e.length; n++) t = this.cardsPool.size() > 0 ? this.cardsPool.get() : cc.instantiate(this.pb_Cards),
            ...
            t.getComponent("RunCards").cardsCreate(e[n].val, e[n].type),
            i.push(t);
        i = this.allSorting(i);
        var o = null,
            a = null;
    ...
    allSorting(e) {
        ...
        for (var i = 0,
                ...
                o = null,
                a = null; i < e.length; i++)
            if (e[i].getComponent("RunCards").val > 13) n = i;
            else if (2 == e[i].getComponent("RunCards").val || 1 == e[i].getComponent("RunCards").val) {
            o = i;
            break
        }
        if (null == n && null != o) {
    ...
    pureType() {
        ...
        for (var e = 0; e < this.CardsNum.length; e++) {
            for (var t = [], i = 0, n = this.playerCards.length - 1; n > -1; n--) this.CardsNum[e] == this.playerCards[n].getComponent("RunCards").val && (14 == this.CardsNum[e] || 15 == this.CardsNum[e] ? (t.push(this.playerCards[n]), i += 5) : (t.push(this.playerCards[n]), i++));
                            ...
                            if (s.length < i / 3) {
                                ...
                                e: for (var c = this.playerCards.length - 1; c > -1; c--)
                                    for (var l = 0; l < r && n[l].getComponent("RunCards").val != this.playerCards[c].getComponent("RunCards").val; l++) {
                                        if ((14 == this.playerCards[c].getComponent("RunCards").val || 15 == this.playerCards[c].getComponent("RunCards").val) && kingNum < 1) kingNum++;
                                        else if ((14 == this.playerCards[c].getComponent("RunCards").val || 15 == this.playerCards[c].getComponent("RunCards").val) && 1 == kingNum) break;
                        ...
                        if (n.push(this.cardsGroup[2][a + o][0]), n.push(this.cardsGroup[2][a + o][1]), n.push(this.cardsGroup[2][a + o][2]), n.length == i) {
                            ...
                            for (var c = 0; c < s.length; c++)
                                for (var r = 0; r < this.cardsGroup[1].length; r++)
                                    if (this.cardsGroup[1][r][0].getComponent("RunCards").val == s[c].getComponent("RunCards").val)
    ...
    differentZu(e, t) {
        for (var i = [], n = 0; n < e.length; n++)
            for (var o = 0; o < t.length && (e[n].getComponent("RunCards").val != t[o].getComponent("RunCards").val || e[n].getComponent("RunCards").type != t[o].getComponent("RunCards").type); o++) o == t.length - 1 && i.push(e[n]);
    ...
    coincidence(e, t) {
        ...
        for (var i = 0; i < t.length; i++)
            for (var n = 0; n < e.length && t[i].getComponent("RunCards").val != e[n].getComponent("RunCards").val; n++)
                if (n == e.length - 1) return cc.log(t[i].getComponent("RunCards").val),
                    false;
        return !0
    },
    yiDong(e) {
        for (var t = 0; t < e.length; t++) e[t].getComponent("RunCards").moveCard()
    },
    yiJi(e, t) {
                        ...
                        if (n.push(this.cardsGroup[3][s][r]), 4 == n.length) {
                            ...
                            if (n.length < e.length) {
                                for (var c = 0; c < this.cardsGroup[1].length; c++)
                                    if (this.cardsGroup[1][c][0].getComponent("RunCards").val != n[0].getComponent("RunCards").val)
                                ...
                                for (var c = 0; c < this.cardsGroup[3].length; c++)
                                    if (this.cardsGroup[3][c][0].getComponent("RunCards").val != n[0].getComponent("RunCards").val)
