cc.Class({
     ...
     * 点击斗地主按钮
     */
    landButtonClick_Function: function () {
     ...
     * 点击红包达人按钮
     */
    hongbao_ButtonClick_Function: function () {
        if (cc.sys.isNative && this.canvasNode.getComponent("LobbyMain").playerInfo.needToUpdate[1]) {
     ...
     * 点击跑得快按钮
     */
    runButtonClick_Function: function () {
        if (cc.sys.isNative && this.canvasNode.getComponent("LobbyMain").playerInfo.needToUpdate[7]) {
     ...
     * 点击德州扑克按钮
     */
    dzButtonClick_Function: function () {
        if (cc.sys.isNative && this.canvasNode.getComponent("LobbyMain").playerInfo.needToUpdate[7]) {
     ...
     * 点击诈金花按钮
     */
    zjhButtonClick_Function: function () {
        if (cc.sys.isNative && this.canvasNode.getComponent("LobbyMain").playerInfo.needToUpdate[7]) {
     ...
     * 点击财神到按钮
     */
    CaishendaoButtonClick_Function: function () {
     ...
     * 点击上海00发按钮
     */
    SH00FButtonClick_Function: function () {
     ...
     * 点击太极熊猫按钮
     */
    TaijiPandaButtonClick_Function: function () {
 ...
 * 点击梦幻女神按钮
 */
    MHNSButtonClick_Function: function () {
 ...
 * 点击一路发发按钮
 */
    YLFFButtonClick_Function: function () {
 ...
 * 点击五福临门按钮
 */
    WFLMButtonClick_Function: function () {
     ...
     * 点击忠肝义胆按钮
     */
    ZHYDButtonClick_Function: function () {
     ...
     * 点击玉蒲团2按钮
     */
    YPT2ButtonClick_Function: function () {
     ...
     * 点击潘金莲按钮
     */
    PJLButtonClick_Function: function () {
     ...
     * 点击哪吒闹海按钮
     */
    NZNHButtonClick_Function: function () {
     ...
     * 点击吕布戏貂蝉按钮
     */
    LBXDCButtonClick_Function: function () {
     ...
     * 点击水果钻石按钮
     */
    DiamondButtonClick_Function: function () {
     ...
     * 点击财源滚滚按钮
     */
    CYGGButtonClick_Function: function () {
     ...
     * 点击埃及珍宝按钮
     */
    EFButtonClick_Function: function () {
 ...
 * 点击冰球突破按钮
 */
    BQTPButtonClick_Function: function () {
...
* 点击美女游泳队按钮
*/
    MNYYDButtonClick_Function: function () {
 ...
 * 点击月光宝盒按钮
 */
    YGBHButtonClick_Function: function () {
 ...
 * 点击僵尸先生按钮
 */
    JSXSButtonClick_Function: function () {
 ...
 */
    ...
    BonusBearsButtonClick_Function: function () {
     ...
     * 点击水果机按钮
     */
    ShuiguojiButtonClick_Function: function () {
 ...
 * 点击水果机竖版 按钮
 */
    ShuiguojishubanButtonClick_Function: function () {
        this.QieHuanScene('game_shuiguoji_shuban');
    },
    /**
    * 点击铃铛游戏按钮
    */
    LingdangyouxiButtonClick_Function: function () {
        this.QieHuanScene('game_lingdangyouxi');
    },
    /**
     * 点击Safari按钮
     */
    SafariButtonClick_Function: function () {
        this.QieHuanScene('game_Safari');
    },
    /**
 * 点击RomeGlory按钮
 */
    RomeGloryButtonClick_Function: function () {
 ...
 * 点击RomeGlory按钮
 */
    jokerButtonClick_Function: function () {
        this.QieHuanScene('Slot_joker');
    },
    /**
* 点击alading按钮
*/
    aladingButtonClick_Function: function () {
...
*/
    ...
    yuputuanButtonClick_Function: function () {
...
* 点击水果小玛丽按钮
*/
    sgxmlButtonClick_Function: function () {
...
* 点击阿兹特克按钮
*/
    AZTKButtonClick_Function: function () {
     ...
     * 点击财神夺宝按钮
     */
    CSDBButtonClick_Function: function () {
 ...
 * 点击维加斯之夜按钮
 */
    WJSZYButtonClick_Function: function () {
    ...
    * 点击财神到按钮
    */
    CSDHYButtonClick_Function: function () {
...
* 点击Fire88按钮
*/
    Fire88ButtonClick_Function: function () {
...
* 点击西游记 按钮
*/
    XYJButtonClick_Function: function () {
     ...
     * 点击ATT连环炮
     */
    ATTButtonClick_Function: function () {
     ...
     * 点击精灵女王按钮
     */
    JinwButtonClick_Function: function () {
        // if(cc.sys.isNative && this.canvasNode.getComponent("LobbyMain").playerInfo.needToUpdate[7])
        // {
     ...
     * 点击万圣节按钮
     */
    WsjButtonClick_Function: function () {
        this.QieHuanScene('game_wsj');
    },
    /**
     * 点击3D足球按钮
     */
    FootballButtonClick_Function: function () {
 ...
 */
     ...
     * 连环夺宝
     */
    lhdbButtonClick_Function: function () {
     ...
     * 点击进入欧洲轮盘房间
     */
    rouletteRoomButtonClick_Function: function () {
    ...
    onClickPoxy(e, v) {
        ...
        Helper.http('http://game.bullsts.com/index.php/agent/api/clientShow', sendData).then(e => {
    ...
    //点击进入龙虎斗
    longhuDouButtonClick(event, customEventData) {
        let tempNetWork = require("longhudouNetWork").getInstant;
    ...
    //点击进入西游争霸
    xiyouzhengbaButtonClick(event, customEventData) {
        cc.find('Canvas/Loading').active = true;
        event.currentTarget.getComponent(cc.Button).interactable = false;
    ...
    //点击进入21点
    blackJackButtonClick(event, customEventData) {
        cc.find('Canvas/Loading').active = true;
        event.currentTarget.getComponent(cc.Button).interactable = false;
    ...
    //点击进入森林舞会
    zenlinwuhuiButtonClick(event, customEventData) {
        cc.find('Canvas/Loading').active = true;
        event.currentTarget.getComponent(cc.Button).interactable = false;
    ...
    //点击进入百家乐
    baijialeButtonClick(event, customEventData) {
        let tempNetWork = require("baijialeNetWork").getInstant;
        cc.find('Canvas/Loading').active = true;
        event.currentTarget.getComponent(cc.Button).interactable = false;
        tempNetWork.loginGame_Function('', 16004, tempNetWork.playerInfo.playerId, tempNetWork.playerInfo.gameSign);
    },
    //点击进入白人牛牛
    bairenniuniuButtonClick(event, customEventData) {
        let tempNetWork = require("bairenniuniuNetWork").getInstant;
        cc.find('Canvas/Loading').active = true;
        event.currentTarget.getComponent(cc.Button).interactable = false;
        tempNetWork.loginGame_Function('', 13501, tempNetWork.playerInfo.playerId, tempNetWork.playerInfo.gameSign);
    },
    //点击进入押大小
    yadaxiaoButtonClick(event, customEventData) {
        let tempNetWork = require("yadaxiaoNetWork").getInstant;
        cc.find('Canvas/Loading').active = true;
        event.currentTarget.getComponent(cc.Button).interactable = false;
        tempNetWork.loginGame_Function('', 16005, tempNetWork.playerInfo.playerId, tempNetWork.playerInfo.gameSign);
    },
    //点击进入皇家赛马
    HJSMButtonClick(event, customEventData) {
        cc.find('Canvas/Loading').active = true;
        event.currentTarget.getComponent(cc.Button).interactable = false;
