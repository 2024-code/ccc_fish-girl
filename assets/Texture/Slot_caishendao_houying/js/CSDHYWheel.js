...
cc.Class({
    ...
    startRoll(...args) {
        ...
        setTimeout(() => {
            ...
            this.node.runAction(
                cc.sequence(
                    cc.delayTime(0.2),
                    cc.moveTo(timer, cc.v2(this.node.x, -this.node.height + 480)),
                    cc.moveTo(0.1, cc.v2(this.node.x, -this.node.height + 540)),
                    cc.moveTo(0.1, cc.v2(this.node.x, -this.node.height + 480)),
    ...
    stopImmediately() {
        ...
        setTimeout(() => {
            this.node.y = -this.node.height + 480;
        }, 50);
        this.status = 0;
        this.mainObj.stateCallBack();
    },
