    ...
    startRoll(...args) {
        ...
        setTimeout(() => {
            ...
            this.node.runAction(
                cc.sequence(
                    cc.delayTime(0.2),
                    cc.moveTo(timer, cc.v2(this.node.x, -this.node.height + 485)),
                    cc.moveTo(0.1, cc.v2(this.node.x, -this.node.height + 500)),
                    cc.moveTo(0.1, cc.v2(this.node.x, -this.node.height + 485)),
