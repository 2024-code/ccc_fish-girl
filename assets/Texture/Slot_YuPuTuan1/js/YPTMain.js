...
cc.Class({
    ...
    showAnim(cols, index, beishu) {
        ...
        this.wheelList[cols].rolePbList[length - 3 - index].getComponent("TempAnimation").playAnim();
        //添加
    ...
    clsoeAnim(cols, index) {
        let length = this.wheelList[cols].roleIdList.length;
        this.wheelList[cols].rolePbList[length - 3 - index].getComponent("TempAnimation").stopAnim();
        //添加
