...
cc.Class({
    ...
    startRoll(...args) {
        ...
        setTimeout(() => {
            ...
            this.node.runAction(
                cc.sequence(
                    cc.delayTime(0.2),
                    cc.moveTo(timer, cc.v2(this.node.x, -this.node.height + 528)),//432
                    cc.moveTo(0.1, cc.v2(this.node.x, -this.node.height + 596)),//500
                    cc.moveTo(0.1, cc.v2(this.node.x, -this.node.height + 528)),//432
    ...
    stopImmediately() {
        ...
        setTimeout(() => {
            this.node.y = -this.node.height + 528;//432
        }, 50);
        this.status = 0;
        this.mainObj.stateCallBack();
    },
