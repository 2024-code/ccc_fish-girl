...
cc.Class({
    ...
    startBigWin() {
        ...
        this.bigWinNode.getChildByName("slots_bonus_wheel").getChildByName("slots_bonus_wheel_muti").rotation = 0;
    ...
    bigWinBegin(event, customentData) {
        ...
        this.bigWinBoo = false;
        let tempWheel = this.bigWinNode.getChildByName("slots_bonus_wheel").getChildByName("slots_bonus_wheel_muti");
        let tempDu = 0;
        ...
        tempWheel.runAction(cc.sequence(cc.rotateBy(0.5, 360),
            ...
            cc.callFunc(()=>{
                ...
                this.bigWinResultAnim.opacity = 0;
                this.bigWinResultAnim.runAction(cc.sequence(cc.fadeIn(0.5), cc.delayTime(1), cc.callFunc(()=>{
                    this.bigWinResultAnim.active = false;
                })));
                this.lblUserCoin.string = (this.bigWinResultCoin / 100).toFixed(2);
                this.lblWinCoin.string = (this.bigWinCoin / 100).toFixed(2);
                this.bigWinResultAnim.getChildByName('beishu').getComponent(cc.Label).string = "x" + this.bigWinCard;
            })
        ));
    },
