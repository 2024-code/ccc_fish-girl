...
cc.Class({
    ...
    startRoll(...args) {
        ...
        setTimeout(() => {
            ...
            this.node.runAction(
                cc.sequence(
                    cc.delayTime(0.2),
                    cc.moveTo(timer, cc.v2(this.node.x, -this.node.height + 1032)),
                    cc.moveTo(0.1, cc.v2(this.node.x, -this.node.height + 900)),
                    cc.moveTo(0.1, cc.v2(this.node.x, -this.node.height + 1032)),
    ...
    stopImmediately() {
        ...
        setTimeout(() => {
            this.node.y = -this.node.height + 1032;
        }, 50);
        this.status = 0;
        this.mainObj.stateCallBack();
    },
