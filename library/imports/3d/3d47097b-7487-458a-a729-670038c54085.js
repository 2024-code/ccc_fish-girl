"use strict";
cc._RF.push(module, '3d470l7dIdFiqcpZwA4xUCF', 'IrishLuckWheel');
// Texture/slot_LrishLuck/js/IrishLuckWheel.js
...
cc.Class({
  ...
  onLoad: function onLoad() {
    this.audio = cc.director.getScene().getChildByName('Canvas').getComponent('IrishLuckAudio');
    this.mainObj = cc.director.getScene().getChildByName('Canvas').getComponent('IrishLuckMain');
