"use strict";
cc._RF.push(module, 'ef259LGhnRCxp8j883TGlLU', 'MNYYDWheel');
// Texture/Slot_meinvyouyongdui/js/MNYYDWheel.js
...
cc.Class({
  ...
  onLoad: function onLoad() {
    this.audio = cc.director.getScene().getChildByName('Canvas').getComponent('MNYYDAudio');
    this.mainObj = cc.director.getScene().getChildByName('Canvas').getComponent('MNYYDMain');
  ...
  startRoll: function startRoll() {
    ...
    setTimeout(function () {
      ...
      _this.node.runAction(cc.sequence(cc.delayTime(0.2), cc.moveTo(timer, cc.v2(_this.node.x, -_this.node.height + 700)), cc.moveTo(0.1, cc.v2(_this.node.x, -_this.node.height + 780)), cc.moveTo(0.1, cc.v2(_this.node.x, -_this.node.height + 700)), cc.callFunc(_this.rollCallBack.bind(_this))));
    }, 100);
  },
  ...
  stopImmediately: function stopImmediately() {
    ...
    setTimeout(function () {
      _this2.node.y = -_this2.node.height + 700;
    }, 50);
    this.status = 0;
    this.mainObj.stateCallBack();
  }
